...
В [документации](https://github.com/max-messenger-client/max-bot-api-client-go/tree/master/docs) вы можете найти подробные инструкции по использованию фреймворка.
